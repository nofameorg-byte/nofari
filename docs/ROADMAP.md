...
## Sprint 003: Intelligence Core

- Establish the provider-neutral Intelligence Pipeline.
- Add replaceable stage interfaces for intent, planning, resource routing, reasoning, verification,
  response shaping, and memory update preparation.
- Keep the sprint architecture-only with no AI provider calls, chat behavior, uploads,
  authentication, persistence, or mock answers.

## Sprint 004: Product Contracts
...
- Keep authentication, data modeling, upload handling, and provider-backed intelligence logic
